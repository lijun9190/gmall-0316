...
public class AttrController {
    ...
    public ResponseVo<List<AttrEntity>> querySpuInfo(@PathVariable("gid") Long gid){
    ...
    public ResponseVo<List<AttrEntity>> queryByCidAndType(@PathVariable("catId") Long catId,
                                                          @RequestParam(value = "type",required = false) Long type,
                                                          @RequestParam(value ="searchType",required = false) Long searchType
                                                          ){
        QueryWrapper<AttrEntity> queryWrapper=new QueryWrapper<>();
       List<AttrEntity> attrEntitiesList =attrService.queryByCidAndType(catId,type,searchType);

        return ResponseVo.ok(attrEntitiesList);
    }
