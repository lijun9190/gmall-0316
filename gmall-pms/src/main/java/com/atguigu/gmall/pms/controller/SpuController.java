...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> pageByCategoryId(@PathVariable("categoryId") Long categoryId,PageParamVo pageParamVo) {
        PageResultVo pageResultVo = this.spuService.selectList(pageParamVo, categoryId);
        return ResponseVo.ok(pageResultVo);
    };
