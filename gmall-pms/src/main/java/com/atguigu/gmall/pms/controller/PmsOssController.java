...
public class PmsOssController {
    ...
    public ResponseVo<Object> policy() throws UnsupportedEncodingException {
        String accessId = "LTAI4GEjKyhyS51TXg3NTDXg"; // 请填写您的AccessKeyId。
        String accessKey = "cd5cL4AWS58iMTuJPnHJBTQjGecnVQ"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "guli200316"; // 请填写您的 bucketname 。
